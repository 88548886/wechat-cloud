...
@Slf4j
public class MjoysLengthFieldBasedFrameDecoder extends LengthFieldBasedFrameDecoder {
     ...
     */
    public MjoysLengthFieldBasedFrameDecoder(int maxFrameLength, int lengthFieldOffset, int lengthFieldLength,
